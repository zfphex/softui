...
const BORDER: u32 = rgb(89, 87, 91);
const BACKGROUND: u32 = rgb(32, 32, 32);
...
const ZOOM_OUTER_BORDER: u32 = rgb(66, 66, 66); //1px
const ZOOM_INNER_BORDER: u32 = rgb(39, 39, 39); //3px
