...
fn main() {
    ...
    for col in 0..10 {
        ...
        for row in 0..100 {
            let item = tree6.add_node(
                &format!("Item{}_{}", col, row),
                Sizing::Fill,
                Sizing::Fixed(10.0),
                Direction::LeftToRight,
                0.0,
