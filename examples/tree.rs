...
fn main() {
    ...
    let p1 = tree1.add_node(Unit::Fixed(1000.0), Unit::Fixed(1000.0), Direction::LeftToRight, 0.0, 0.0);
    for i in 0..100 {
        let child = tree1.add_node(Unit::Fill, Unit::Fixed(10.0), Direction::LeftToRight, 0.0, 0.0);
    ...
    let mut current = tree2.add_node(Unit::Fixed(1000.0), Unit::Fixed(1000.0), Direction::LeftToRight, 0.0, 0.0);
    for i in 1..10 {
    ...
    fn build_tree(tree: &mut Tree, depth: usize, parent: usize) {
        ...
        for i in 0..3 {
            let child = tree.add_node(Unit::Fill, Unit::Fill, Direction::LeftToRight, 0.0, 0.0);
            tree.add_child(parent, child);
            build_tree(tree, depth - 1, child);
        }
    }
    let mut tree3 = Tree::new();
    let root3 = tree3.add_node(Unit::Fixed(1000.0), Unit::Fixed(1000.0), Direction::LeftToRight, 0.0, 0.0);
    ...
    let p4 = tree4.add_node(Unit::Fixed(1000.0), Unit::Fixed(1000.0), Direction::LeftToRight, 0.0, 0.0);
    for i in 0..20 {
        ...
        let child = tree4.add_node(sizing, Unit::Fixed(10.0), Direction::LeftToRight, 0.0, 0.0);
        tree4.add_child(p4, child);

        if sizing == Unit::Fit {
            // Add a child for Fit sizing
            let grandchild = tree4.add_node(Unit::Fixed(10.0), Unit::Fixed(10.0), Direction::LeftToRight, 0.0, 0.0);
    ...
    let root5 = tree5.add_node(Unit::Fixed(1920.0), Unit::Fixed(1080.0), Direction::TopToBottom, 0.0, 10.0);
    // Header
    let header = tree5.add_node(Unit::Fill, Unit::Fixed(60.0), Direction::LeftToRight, 0.0, 10.0);
    tree5.add_child(root5, header);
    for i in 0..5 {
        let btn = tree5.add_node(Unit::Fixed(100.0), Unit::Fill, Direction::LeftToRight, 0.0, 5.0);
        tree5.add_child(header, btn);
    }
    // Content area
    let content = tree5.add_node(Unit::Fill, Unit::Fill, Direction::LeftToRight, 0.0, 0.0);
    tree5.add_child(root5, content);
    // Sidebar
    let sidebar = tree5.add_node(Unit::Fixed(250.0), Unit::Fill, Direction::TopToBottom, 0.0, 0.0);
    tree5.add_child(content, sidebar);
    for i in 0..10 {
        let item = tree5.add_node(Unit::Fill, Unit::Fixed(40.0), Direction::LeftToRight, 0.0, 0.0);
        tree5.add_child(sidebar, item);
    }
    // Main content
    let main = tree5.add_node(Unit::Fill, Unit::Fill, Direction::TopToBottom, 0.0, 0.0);
    tree5.add_child(content, main);
    for i in 0..20 {
        let row = tree5.add_node(Unit::Fill, Unit::Fixed(50.0), Direction::LeftToRight, 0.0, 0.0);
    ...
    let root6 = tree6.add_node(Unit::Fixed(1000.0), Unit::Fixed(1000.0), Direction::LeftToRight, 0.0, 0.0);
    // Create 10 columns with 100 items each
    for col in 0..10 {
        let column = tree6.add_node(Unit::Fill, Unit::Fill, Direction::TopToBottom, 0.0, 0.0);
        tree6.add_child(root6, column);

        for row in 0..100 {
            let item = tree6.add_node(Unit::Fill, Unit::Fixed(10.0), Direction::LeftToRight, 0.0, 0.0);
